...
var navMenu = document.querySelector(".nav__items");
...
var bloque = document.querySelectorAll('.bloque'); //Recorremos todos los li
...
var punto = document.querySelectorAll('.punto'); //Recogemos todos los puntos
...
punto.forEach(function (cadaPunto, i) {
  ...
  punto[i].addEventListener('click', function () {
    ...
    var operacion = posicion * -50; //Movemos el grande

    grande.style.transform = "translateX(".concat(operacion, "%)"); //Recorremos todos los puntos
